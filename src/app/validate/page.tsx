      ...
      <div className="flex-1 max-h-full">
        <div className="p-4 bg-gray-200 h-full flex">
          <div className="grid grid-cols-1 grid-rows-[auto,1fr,1fr,auto] w-full max-h-full">
            <h2 className="py-2 text-xl text-center font-extrabold">Validate</h2>
            <div className="bg-slate-100 flex-1 flex flex-col">
              ...
              <div ref={fillerDivRef} className="flex-1">
                <ImageCarousel images={images} height={divHeight} width={divWidth} />
              </div>
            </div>
            ...
            <Button className="my-3 max-w-xs flex-0 place-self-center" color="primary">
              Confirm Validation
            </Button>
          </div>
        </div>
